...
struct proc
{
  ...
  uint ctime;                 // Tick that process has been created;
  int stime;                  // Number of ticks the process has been in the SLEEPING state
  int rutime;                 // Number of ticks the process has run for
